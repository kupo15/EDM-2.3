...
draw_text_color(-130,room_height-100,string(mx)+" , "+string(my),col,col,col,col,1);

if mouse_check_button(mb_middle)
	{
	draw_text_color(-130,room_height-100+40,"["+string(mx_d)+" , "+string(my_d)+"]",col,col,col,col,1);
