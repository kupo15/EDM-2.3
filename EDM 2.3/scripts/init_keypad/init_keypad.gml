...
function init_keypad(entry_enum,initValue="",blankValue="-",xx=obj_number_input.x,yy=obj_number_input.y,clickout_x1=undefined,clickout_y1=undefined,clickout_x2=undefined,clickout_y2=undefined) {
