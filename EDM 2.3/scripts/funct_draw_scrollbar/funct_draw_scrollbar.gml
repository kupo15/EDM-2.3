/// @description  funct_draw_scrollbar(x,y,rows,yoff,asset_num,scroll_ww,offset_var,ysep,width_off);
/// @param x
/// @param y
/// @param rows
/// @param yoff
...
/// @param ysep
/// @param width_off
function funct_draw_scrollbar(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8) {
